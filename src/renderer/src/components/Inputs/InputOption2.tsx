        ...
        <div className="flex gap-2">
            <div className="btn-group p-0 w-auto mb-3" role="group" aria-label="Basic radio toggle button group">
                <Field
                    ...
                    className="btn-check" 
                />
                <label className="btn btn-outline-secondary align-content-center" htmlFor={`id${nome}1`} >
                    {texto1}
                </label>
                ...
                />
                <label className="btn btn-outline-secondary align-content-center" htmlFor={`id${nome}2`} >
                    {texto2}
                </label>
            </div>
